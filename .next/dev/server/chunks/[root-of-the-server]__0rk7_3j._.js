...
async function GET(req) {
    try {
        ...
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            createdAt: -1
        });
...
async function POST(req) {
    try {
        ...
        const payload = token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyAccessToken"])(token) : null;
        ...
        const { title, category, categorySlug, price, shortDescription, description, image, images, isBestSeller, customizable, occasion } = body;
        ...
        const newProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title: title.trim(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rk7_3j._.js.map